...
**** Backend dependencies
     ...
     Backend calculations are using Incanter. Bleeding edge version is needed as
     it fixes some crucial bugs. Having the latest `develop` version in a local
     maven repo is recommended.
...
** I/O
   ...
   #+BEGIN_SRC clojure :tangle ../src/clj/pva_parrot/io.clj
   (ns pva-parrot.io
