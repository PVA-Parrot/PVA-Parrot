...
* Todos
** FIXED org file needs to be split, gets way too slow
   :LOGBOOK:
   - State "FIXED"      from ""           [2015-03-07 Sat 21:08]
   - State "CHORE"      from ""           [2015-03-07 Sat 11:44]
   :END:
   <2015-03-07 Sat>
** CHORE it's about time to start adding tests I guess
   :LOGBOOK:
   - State "CHORE"      from "IDEA"       [2015-03-07 Sat 21:09]
...
** IDEA use datatables
   ...
   - State "IDEA"       from ""           [2015-03-07 Sat 21:09]
   :END:
   see reagent cookbook: https://github.com/reagent-project/reagent-cookbook
